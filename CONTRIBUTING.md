# Contributing to gcp-ai-log-pipeline

## Project scope

Cloud log pipeline prototype. The function currently logs a placeholder for AI ingestion. Treat the README architecture as the target design, not a completed end-to-end ingestion implementation.
